...
const Orderform = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post("http://localhost:8080/savedata",paranormal);
  ...
  return (
    ...
    <div className="container">
      ...
      <Form.Group controlId="formSubName">
          ...
          <Form.Control className='hii' type="number" placeholder="Enter Id" value={id} onChange={handleIdChange} required/>
        </Form.Group>
        ...
        <Form.Group controlId="formSubName">
          ...
          <Form.Control className='hii' type="date" placeholder="Enter date_of_channel_creation" value={cc} onChange={handleCcChange}/>
        </Form.Group>
